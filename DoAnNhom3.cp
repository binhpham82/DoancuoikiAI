...
Node* childNode(Node* node, int action)
{
	...
	temp->parent = node;
	int x = temp->x0 + X[action];
	int y = temp->y0 + Y[action];
	temp->state[temp->x0][temp->y0] = temp->state[x][y];
	temp->state[x][y] = 0;
	temp->x0 = x;
	temp->y0 = y;
...
void deleteNodeList(Node_List* NodeList)
{
	Node* root = NodeList->head;
	while (root != NULL)
	{
...
{
	if (node->x0 + X[action] < 0 || node->x0 + X[action] >= n)
		return false;
	if (node->y0 + Y[action] < 0 || node->y0 + Y[action] >= n)
		return false;
	return true;
}
...
bool testNodeList(Node_List* node)
{
	Node* a = node->head;
	while (a->nextNode != NULL)
	{
		if (a->cost > a->nextNode->cost)
			return false;
	}
	return true;
}

void listMove(Node* start, Node* bridge, Node*& goal)
{
	delete goal;
	goal = bridge;
	Node* root = goal;
...
void setUpGame(Node*& start, Node*& goal)
{
	...
	if (choise == 1)
	{
		do
		{
			randomTable(start->state);	
			findZero(start);
...
bool shakeCoin()
{
	for (int i = 0; i < 25; i++)
	{
		gotoxy(0, n * 4 + 2); printf(" %c%c%c ",196,196,196);
		gotoxy(0, n * 4 + 3); std::cout << "|" << (i % 2 == 0 ? "YES" : "NO ") << "|";
		gotoxy(0, n * 4 + 4); printf(" %c%c%c ", 196, 196, 196);
		Sleep(50);
	}
	if (rand() % 2 == 0)
	{
		gotoxy(0, n * 4 + 3); std::cout << "|YES|";
		return true;
	}
	else
	{
		gotoxy(0, n * 4 + 3); std::cout << "|NO |";
		return false;
	}
}
...
void paintMove(Node*& start, int action)
{
	...
	if (action == start->child->action)
	{
		...
		paintCell(start->x0 * 7, start->y0 * 3, child->state[start->x0][start->y0],true);
		earseCell(child->x0 * 7, child->y0 * 3);
		delete start;
		start = child;
		start->parent = NULL;
	}
	else
	{
		...
		showTable(0, 0, start->state);
		paintCell(start->x0 * 7, start->y0 * 3, parent->state[start->x0][start->y0],true);
		earseCell(parent->x0 * 7, parent->y0 * 3);
		parent->child = start;
		start->parent = parent;
		start = parent;
		start->parent = NULL;
